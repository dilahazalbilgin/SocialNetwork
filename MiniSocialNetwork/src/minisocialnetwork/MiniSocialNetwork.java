    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (ans) {
                ...
                case 10:
                    System.out.print("Enter Your User ID to view the activity feed: ");
                    int activityFeedUserId = scan.nextInt();
                    network.viewActivityFeed(activityFeedUserId);
                    network.viewNewsFeed(activityFeedUserId);
                    break;
                case 11:
