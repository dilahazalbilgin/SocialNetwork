...
public class MiniSocialNetwork {
    ...
    public static void main(String[] args) {
        ...
        network.postMessage(1, "Dila's first post!");
        network.postMessage(2, "Cerenn's first post!");
        network.postMessage(3, "Nisa's first post!");
        network.postMessage(4, "Sevde's first post!");
        ...
        while (true) {
            ...
            System.out.println("9 - News Feed");
            System.out.println("10- Activity Feed");
            System.out.println("11 - Search User");
            System.out.println("12 - Recommend Friends");
            ...
            switch (ans) {
                case 1:
                    if (!isUsersAdded) {
                        network.addUser(5, "Hazal");
                        network.addUser(6, "Sude");
                        network.addUser(7, "Özge");
                        network.addUser(8, "Sevde");
                        isUsersAdded = true;
                ...
                case 10:
                    network.viewActivityFeed(1);
                    network.viewActivityFeed(2);
                    network.viewActivityFeed(3);
                    network.viewActivityFeed(4);
                    break;
                case 11:
