...
public class Network {
    ...
    public void viewActivityFeed(int userId) {
        ...
        System.out.println(user.getName() + " Activity Feed:");

        List<ActivityFeed> allActivities = new ArrayList<>(user.getActivityFeed());

        for (Post post : user.getPosts()) {
            allActivities.add(new ActivityFeed( post.getContent()));
        }
